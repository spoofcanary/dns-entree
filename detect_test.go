...
func TestDetectFromNS(t *testing.T) {
	cases := []struct {
		...
		{"namecheap", []string{"dns1.namecheaphosting.com"}, ProviderType("namecheap"), "Namecheap", true},
		...
		{"registrar-servers", []string{"dns1.registrar-servers.com"}, ProviderType("namecheap"), "Namecheap", true},
