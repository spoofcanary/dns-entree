...
func (s *Server) handleMigrate(w http.ResponseWriter, r *http.Request) {
	// D-13: the synchronous one-shot endpoint is deprecated in favor of
	// /v1/migrate/preview + /v1/migrate/{id}/apply + /v1/migrate/{id}/verify.
	// Removed in the release after v0.2.0.
	w.Header().Set("Deprecation", "true")
	w.Header().Set("Sunset", "Wed, 01 Oct 2026 00:00:00 GMT")
	w.Header().Set("Link", `</v1/migrate/preview>; rel="successor-version"`)
